...
## 6. DNS, HTTPS &amp; reverse-proxy (Caddy)

Point these A-records to your server IP:
- `asoftechinsightz.com`        → server IP
- `app.asoftechinsightz.com`    → server IP
- `flows.asoftechinsightz.com`  → server IP   (n8n)
