...
## 6. Frontend
- [ ] All 10 pages render: `/`, `/about`, `/products`, `/leadedge360`, `/retailedge360`, `/pricing`, `/blog`, `/contact`, `/privacy`, `/terms`
- [ ] DPDP consent banner appears on first visit (incognito)
- [ ] Sign-in flow with DPDP checkboxes works
- [ ] LeadEdge360 dashboard: KPIs, charts, lead creation, status change, WhatsApp deep-link, rescore all work
- [ ] RetailEdge360 dashboard: KPIs, charts, SKU creation with AI shelf-life prediction
- [ ] Mobile view (390x844) shows hamburger and full nav
