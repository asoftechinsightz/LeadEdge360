  ...
  return (
    <SiteShell>
      <section className="container py-16 max-w-3xl">
        <Badge variant="outline" className="rounded-full border-primary/30 text-primary mb-5">Privacy &amp; DPDP Notice</Badge>
        <h1 className="font-display font-bold text-5xl">Privacy Policy</h1>
        <p className="text-muted-foreground mt-3">Last updated: {updated}</p>
        ...
        <Section title="4. Your DPDP rights">
          You may exercise the following rights at any time by writing to <a href="mailto:enquiry@asoftechinsightz.com" className="text-primary hover:underline">enquiry@asoftechinsightz.com</a>:
        ...
        <Section title="8. Grievance officer">
          ...
          <div className="mt-2 rounded-lg border border-border/40 p-3 bg-card/40">
            <div>Name: <strong>Grievance Officer, AsoftechInsightz Pvt. Ltd.</strong></div>
            <div>Email: <a href="mailto:enquiry@asoftechinsightz.com" className="text-primary hover:underline">enquiry@asoftechinsightz.com</a></div>
        ...
        <p className="mt-10 text-sm text-muted-foreground">See also: <Link href="/terms" className="text-primary hover:underline">Terms of Service</Link></p>
      </section>
    </SiteShell>
  )
}
